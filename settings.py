...
try:
    ...
    # 邮箱配置
    #################################
    STMPSERVER = 'smtp.ym.163.com'
    PORT = 25
    EMAILUSER = 'zuoxiaoliang@wolongdata.com'
    EMAILPASSWORD = 'zxl3901yx'


    #################################
    # redis table cached setting
    #################################

    HIT_BOOKS = 'book_list'
    COLLECBOOKS = 'collections'
    ...
    # celery的配置
    ###################################
    RABBITMQ_USERNAME = 'shawn'
    RABBITMQ_PASSWORD = 'shawn'
    RABBITMQ_HOST = '127.0.0.1'
    RABBITMQ_NAME = '127.0.0.1'
